...
<!--control-nav-->
      ...
      角色权限
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/hoo/page/admin">用户</a></li>
    ...
    <div data-wizard="">
                            ...
                            <section>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            ...
                                            <input class="form-control" id="username" name="username" minlength="2" required="" type="text" value="<?php echo ($user["username"]); ?>" <?php echo isset($_GET['n']) ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-circle-o"></i></span>
                                            <input class="form-control" id="passwd" name="passwd" minlength="2" required="" type="password">
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                <?php endif; ?>
                            ...
                            <section>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="firstname">姓</label>
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-pencil"></i></span>
                                            <input class="form-control" id="firstname" name="profile[firstname]"  type="text" value="<?php echo ($profile->firstname); ?>"  <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->

                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="lastname">名 </label>
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-pencil"></i></span>
                                            <input class="form-control" id="lastname" name="profile[lastname]"  type="text" value="<?php echo ($profile->lastname); ?>" <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label" for="mail">邮箱 </label>
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-envelope"></i></span>
                                            <input class="form-control" id="email" name="profile[mail]"  type="email" value="<?php echo ($profile->mail); ?>" <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
							    <div class="form-group">
                                    <label class="col-sm-3 control-label" for="address">电话</label>
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-mobile"></i></span>
                                            <input class="form-control"  name="profile[phone]" type="text" value="<?php echo ($profile->phone); ?>" <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="address">QQ</label>
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            <span class="input-group-addon text-silver"><i class="fa fa-qq"></i></span>
                                            <input class="form-control"  name="profile[qq]" type="text" value="<?php echo ($profile->qq); ?>" <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="input-group input-group-in">
                                            ...
                                            <input class="form-control"  name="profile[address]" type="text" value="<?php echo ($profile->address); ?>" <?php echo !$key ? 'disabled':''; ?> />
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="address">简介</label>
                                    <div class="col-sm-7">
                                            <textarea name="profile[text]" class="form-control" <?php echo !$key ? 'disabled':''; ?> ><?php echo ($profile->text); ?></textarea>
                                    </div>
                                </div><!-- /form-group -->
                             ...
                             <!--  <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                       <div class="nice-checkbox">
                                            <input class="checkbox-o" id="term" name="term" required="" type="checkbox">
                                            <label for="term">
                                                第一登陆重置密码？
                                            </label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="nice-checkbox">
                                        <button class="bt btn-lg btn-primary form-control text-white" type="submit"><?php echo isset($_GET['n']) ? '保存修改':'添加用户'; ?></button>
                                        </div>
                                    </div>
                                </div><!-- /form-group -->
                                <?php endif; ?>
                        ...
                        <div class="panel-body text-center">
                                       <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                <img src="<?php echo $user['avatar']!=''?$user['avatar']:'holder.js/100%x100%'; ?>" alt="">
                                            </div>
                                            <?php if($key): ?>
                                            <div>
                                                <span class="btn btn-sm btn-icon btn-primary btn-file">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <span class="fileinput-new">添加头像</span>
                                                    <span class="fileinput-exists">更换头像</span>
                                                    <input  tid="avatar"  class="hoo-single-image-upload" accept="image/*" type="file"  />
                                                    <input name="avatar" id="avatar" value="<?php echo ($user->avatar); ?>" type="hidden" />
                                                </span>
                                                <input name="avatar2" value="<?php echo ($user->avatar); ?>" type="hidden" />
