...
<!--control-nav-->
      ...
      分类管理
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><?php echo isset($_GET['n'])?'编辑页面':'新建页面'; ?></li>
                    </ul>
...
<div id="panel-fileinput" class="panel panel-default sortable-widget-item">
	<div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                            <input name="post_title" class="form-control" type="text" required="" value="<?php echo ($page["post_title"]); ?>">          
                                    </div><!--/cols-->
                                </div><!--/form-group-->
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                           ...
                                           <option value="<?php echo ($cate["name"]); ?>" <?php echo $page['post_terms']==$cate['name']?'selected="selected"':''; ?>><?php echo ($cate["name"]); ?></option>
                                           <?php endforeach; ?> 
                                           </select>
                                    </div> 
                                </div> 
                                ...
                                <div class="form-group option-groups">
									...
									<input name="groups[]" value="<?php echo ($group); ?>" type="hidden" />
									</div>	
									</div>
                                    <?php endforeach; ?>
								     </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                     ...
                                     <input name="tip_title" class="form-control" placeholder="" type="text" value="<?php echo ($content->tip_title); ?>">
                                ...
                                <div class="form-group hoo-no-padding-botttom">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea class="form-control" rows="10" name="tip_content"  placeholder="" style="margin-bottom:20px"><?php echo ($content->tip_content); ?></textarea>
                                    </div><!--/cols-->
                                </div><!--/form-group-->
   </div><!-- /panel-body -->
   </div>
...
<div id="" class="panel panel-default sortable-widget-item hoo-no-padding">
                        ...
                        <div class="panel-body hoo-no-padding-botttom">
                                ...
                                <div class="form-group hoo-no-padding-botttom ">
                                    ...
                                    <select data-input="selectboxit" placeholder="立即发布" data-native="" name="post_status" class="form-control">
                                            <option value="public" <?php echo $page['post_status']=='public'?'selected="selected"':''; ?>>立即发布</option>
                                            <option value="draft"  <?php echo $page['post_status']=='draft'?'selected="selected"':''; ?>>存为草稿</option>
                                        </select>
                                    </div><!--/cols-->
                                </div><!--/form-group-->
                        ...
                        <button type="submit" class="btn btn-inverse pull-right option-submit" href="#"></i><?php echo isset($_GET['n'])?'保存编辑':'新建页面'; ?></button>
                        ...
                        <div class="panel-body text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                <img src="<?php echo $content->cover!=''?$content->cover:'holder.js/100%x100%'; ?>" alt="">
                                            </div>
                                            <div>
                                                <span class="btn btn-sm btn-icon btn-inverse btn-file">
                                                    ...
                                                    <input name="cover" id="cover" value="<?php echo ($content->cover); ?>" type="hidden" />
                                                </span>
                        ...
                        <div class="panel-body text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 120px; height: 120px;">
                                                <img src="<?php echo $content->logo!=''?$content->logo:'holder.js/100%x100%'; ?>" alt="">
                                            </div>
                                            <div>
                                                <span class="btn btn-sm btn-icon btn-inverse btn-file">
                                                    <i class="fa fa-cloud-upload"></i>
                                                    ...
                                                    <input name="logo" id="logo" value="<?php echo ($content->logo); ?>" type="hidden" />
                                                    </span>
                                                <button class="btn btn-sm btn-icon btn-danger fileinput-exists" data-dismiss="fileinput">
                                                    <i class="fa fa-times"></i>
                                                    删除
