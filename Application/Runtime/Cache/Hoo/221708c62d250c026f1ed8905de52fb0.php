...
<!--control-nav-->
            ...
            <?php $default_file = $system_logs_file[0] == "index.html"? $system_logs_file[1] : $system_logs_file[0]; $filesize = (int)filesize(LOG_PATH.$default_file); $times = 0; while($filesize>1000){ $filesize = round($filesize/1000,2); $times++; } switch($times){ case 1 : $filesize = (int)$filesize; $filesize.="K"; break; case 2 : $filesize.="M"; break; case 3 : $filesize.="G"; break; } ?>	 
                    			</div><!--panel-body-->
                    		</div><!--panel-->
                    	</div><!--cols-->
