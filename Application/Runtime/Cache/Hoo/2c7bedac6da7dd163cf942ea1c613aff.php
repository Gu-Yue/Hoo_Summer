...
<html lang="en">
    ...
    <body class="animated fadeIn">		
					...
					<div class="tab-content">
						<div class="row tab-pane fade in active" id="signin">
							<div class="col-md-12 text-center">							
								<div class="signin col-md-4 col-lg-offset-4">
									<div class="signin-brand">
										<h2>Hoo</h2>
									</div><!--/signin-brand-->
                                    <?php  if(is_array($result)){ echo ' <div class="alert alert-success  hoo-auto-buzz-out">'; foreach($result as $k=>$v){ echo '<i class="icon-exclamation-sign"></i>'; echo $v."<br>"; } echo '</div>'; } ?>
									<form action="" method="POST"  role="form" id="signin-form">
										...
										<div class="form-group ">
											...
											<input type="submit" class="btn btn-lg btn-block btn-primary" value="登陆">
										</div><!--/form-group-->
										...
										<div class="nice-checkbox">
												...
												<label for="keep-signin">记住密码</label>
											</div>
										...
										<p class="margin-top"><a data-toggle="tab" href="#signup"><strong>注册账号</strong></a> <a href="#modalRecover" data-toggle="modal">忘记密码</a></p>
									</form><!--/#signin-form-->
								</div><!--/signin-->
	                                ...
	                                <div class="modal-dialog">
	                                    <div class="modal-content">
	                                        <div class="modal-header">
	                                            ...
	                                            <h4 class="modal-title text-left" id="modalRecoverLabel">忘记密码</h4>
	                                        </div>
	                                        <div class="modal-body">
	                                            <form action="index.php" method="POST" data-validate="form" role="form" id="recover-form">
													...
													<p class="text-muted text-left">Hoo将会发送一个重置密码链接到该邮箱中.</p>
												</form>
	                                        </div>

	                                        <div class="modal-footer">
	                                            <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
	                                            <button type="button" class="btn btn-primary">发送重置链接</button>
	                                        </div>
	                                    </div><!-- /.modal-content -->
	                                </div><!-- /.modal-dialog -->
	                            </div><!-- /.modal -->
						...
						<div class="signup tab-pane fade col-lg-12 text-center" id="signup">
							...
							<form id="signup-form" role="form">
								    <h3 class="col-sm-4 col-md-offset-4">Hoo 创建账户</h3>
									<div class="col-sm-4 col-md-offset-4 margin-top">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" id="btnaddon" type="text">
                                        </div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
                                            <span class="input-group-btn">
                                                <button class="btn btn-primary" type="button">&nbsp;密码&nbsp;</button>
                                            </span>
                                            <input class="form-control" id="btnaddon" type="text">
                                        </div>
										</div>
										...
										<div class="form-group margin-top">
											<div class="nice-checkbox">
												...
												<label for="newsletter">发送账户信息到邮箱</label>
											</div>
										</div>

										<div class="form-group form-actions">
											<input type="submit" class="btn btn-primary btn-lg" value="  创建账户     ">
										</div><!--/form-group-->
										
										<div class="form-group margin-top">
											<div class="nice-checkbox">
												 <span class="col-md-offset-1">已有账户?<a data-toggle="tab" href="#signin">登陆</a></span>
											</div>
										</div>
        ...
        <script src="/bower_components/jquery-selectboxit/src/java/scripts/jquery.selectBoxIt.js"></script>
