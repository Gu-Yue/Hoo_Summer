    ...
    <body class="animated fadeIn">
        ...
        <section class="section">
		   ...
		   <ul class="control-nav pull-right">
		                        <li class="divider"></li>
		                        <li>
		                            <a href="/hoo/page/create/n/<?php echo ($page["id"]); ?>">
		                              分组
		                            </a>
		                        </li>
		                        <li class="divider"></li>
		                        <li class="bg-primary">
		                            <a href="/hoo/page/create/n/<?php echo ($page["id"]); ?>" class="text-white">
		                              编辑页面
		                            </a>
		                        </li>
		                        <li class="divider"></li>
                  ...
                  <?php endif; ?>
                    	...
                    	<div class="col-md-10 col-md-offset-1">
                    		<div class="panel panel-default">
                    			...
                    			<h2 class="panel-title" style="font-size: 20px !important;"><strong><?php echo ($page["post_title"]); ?></strong></h2>
                    			</div><!--panel-heading-->
                    			<div class="panel-body list-group hoo-no-border hoo-no-padding">
                    				<?php foreach($items as $item): ?>
									<div class='list-group-item user-list'>
									<a class="hoo-no-padding-lr list-title" href="/hoo/item/view/n/<?php echo ($item["id"]); ?>"><?php echo ($item["post_title"]); ?></a>
									<div class="hoo-no-padding-lr list-foot">
									<small>	
									    <i class="fa fa-clock-o"></i>  
										<?php echo ($item["post_date"]); ?>&nbsp;&nbsp;&nbsp;
										
										<?php $tags = explode(',',$item['post_terms']); foreach($tags as $tag): ?>
										<?php if($tag!=""): ?>
										<i class="fa fa-tag"></i>  
										<?php echo ($tag); ?>
										<?php endif; ?>
