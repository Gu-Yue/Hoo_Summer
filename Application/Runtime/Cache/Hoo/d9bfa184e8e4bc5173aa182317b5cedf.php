...
<br />
<div class="row-fluid" style="margin: 0px auto; max-width: 960px;">
    <div class="span9 box">
        <div class="box-header box-padding fb-background"><?php echo ($page["post_title"]); ?></div>
        <div class="box-content box-padding">
        <?php foreach($items as $k=>$value): ?>
        <div class="box">
        <div class="box-header fb-background"><?php echo $k; ?></div>	
        <div class="box-content">
        <ul>	
        <?php foreach($value as $v): ?>
        <li><?php echo ($v["post_title"]); ?></li>
        <?php endforeach; ?>
        </ul>
        </div>
        </div>
    ...
    <div class="span3 box">
        <div class="box-content text-center">
               ...
               <a class="btn" href="/admin/item/create/page/<?php echo ($page["id"]); ?>" title="添加文章">
                    <i class="icon-plus" ></i>
                </a>
                <a class="btn" href="/admin/page/create/n/<?php echo ($page["id"]); ?>" title="编辑">
                    <i class="icon-edit" ></i>
                </a>
                <a class="btn" href="/admin/page/delete/n/<?php echo ($page["id"]); ?>" title="数据统计">
                    <i class="icon-bar-chart"></i>
                </a>
            	<a class="btn" href="/admin/page/delete/n/<?php echo ($page["id"]); ?>" title="删除">
        ...
        <li class="text-center"><?php echo $v; ?></li>	
        <?php endforeach; ?>
        </ul>    	 
        </div>
    </div>
