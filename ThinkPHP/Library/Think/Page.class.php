...
class Page{
    ...
    private $config  = array(
        'header' => '<li><a href="#">共 %TOTAL_ROW% 条记录</a></li>',
        'prev'   => '«',
        'next'   => '»',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    private function url($page){
        ...
        return strtolower(str_replace("/index.php","",$url));
    }
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='pagination pagination-sm pull-right hoo-no-margin'>{$page_str}</ul>";
    }
}
